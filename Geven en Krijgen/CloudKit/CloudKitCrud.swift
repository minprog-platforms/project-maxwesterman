...
//
//        guard
//            let image = UIImage(named: "IMG4"),
//            let url = FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?.appendingPathComponent("IMG4.jpeg"),
//            let data = image.jpegData(compressionQuality: 1.0) else { return }
//
//        do {
//            try data.write(to: url)
//            let asset = CKAsset(fileURL: url)
//            nieuwVoorwerp["image"] = asset
...
//                    returnedItems.append(VoorwerpModel(name: name, imageURL: imageURL, record: record))
////                    record.creationDate
...
//                let imageURL = imageAsset?.fileURL
//                returnedItems.append(VoorwerpModel(name: name, imageURL: imageURL, record: returnedRecord))
//            }
//        }
//
//
...
////        record["image"] = nil // zelf toegevoegd
...
//                            Text(voorwerp.name)
//
//                            if let url = voorwerp.imageURL, let data = try? Data(contentsOf: url), let image = UIImage(data: data) {
//                                Image(uiImage: image)
//                                    .resizable()
